...
const fileManagementModules: AnsibleModuleDefinition[] = [
  ...
  { id: 'xml', module: 'community.general.xml', name: 'Manage XML File Content', icon: CodeXml, description: 'Manipulate XML files (add, remove, modify elements/attributes).', defaultParameters: { path: "/path/to/file.xml", xpath: "/root/element[@name='target']", attribute: "value", value: "new_content" } },
